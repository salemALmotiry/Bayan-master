    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable() // Disable CSRF for testing purposes
                ...
                .requestMatchers("/api/v1/bayan/custom-broker/register",
                        ...
                        "/api/v1/bayan/post/get-posts-by-border-name/{borderName}",
                ...
                .requestMatchers(   "/api/v1/bayan/address/add-address",
                        ...
                        ,"/api/v1/bayan/subscription-post/my-posts",
                            "/api/v1/bayan/order/order-details/customer/{orderId}"
                ...
                .requestMatchers("/api/v1/bayan/chat/broker/messages",
                        ...
                        "/api/v1/bayan/offer/my-offer-as-broker",
                        ...
                        "/api/v1//bayan/order/order-details/broker/{orderId}",
                         "/api/v1/bayan/order/my-orders-as-broker",
                ...
                .requestMatchers("/api/v1/bayan/auth/custom-brokers",
                        ...
                        "/api/v1/bayan/auth/custom-brokers/waiting-for-acceptance")
                .hasAuthority("ADMIN")
