...
import com.example.bayan.DTO.OUT.NotificationDTO;
...
public List<NotificationDTO> getAllMyNotifications(Integer customerId) {
    ...
    if (notifications == null || notifications.isEmpty()) {
        throw new ApiException("Customer with ID " + customerId + " does not have any notifications.");
    }

    List<NotificationDTO> notificationDTOS = new ArrayList<>();
    for (Notification notification : notifications) {
        NotificationDTO dto = new NotificationDTO();
        dto.setMassage(notification.getMassage());
