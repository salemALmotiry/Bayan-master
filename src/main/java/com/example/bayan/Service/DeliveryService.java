...
public class DeliveryService {
    ...
    public Map<String, Object> trackAirShipment(String awbNumber) {
        ...
        String url = "https://244e-37-224-52-18.ngrok-free.app/track-shipment";
    ...
    public Map<String, Object> trackSeaContainer(String containerNumber) {
        // منطق للتتبع البحري
        // استدعاء الـ Flask API
        String url = "https://244e-37-224-52-18.ngrok-free.app/track-container";
        Map<String, String> payload = Map.of("container_number", containerNumber);
        Map<String, Object> response = makePostRequest(url, payload);

        // إزالة مفتاح "Bill of Lading" من الاستجابة
        response.remove("Bill of Lading");
    ...
    public Map<String, Object> trackByCarrier(Integer customerId,Integer deliveryId , Integer orderId) {
        ...
        String url = switch (delivery.getCarrier().toLowerCase()) {
            case "aramex" -> "https://244e-37-224-52-18.ngrok-free.app/track-aramex";
            case "dhl" -> "https://244e-37-224-52-18.ngrok-free.app/track-dhl";
            case "naqel" -> "https://244e-37-224-52-18.ngrok-free.app/track-naqel";
