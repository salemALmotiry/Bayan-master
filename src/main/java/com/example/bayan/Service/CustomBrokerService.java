...
CustomBrokerService {
    ...
    public CustomBrokerFilterDTO getByLicenseNumber(String lNumber) {
        CustomsBroker customsBroker = customBrokerRepository.findCustomsBrokerByLicenseNumber(lNumber);
    ...
    public List<CustomBrokerFilterDTO> getAllCustomsByBorder(String border) {
        List<CustomsBroker> customsBrokers = customBrokerRepository.findAllByBorderName(border);
    ...
    public List<CustomBrokerFilterDTO> getAllCustomsByName(String name) {
        List<CustomsBroker> customsBrokers = customBrokerRepository.findCustomsBrokerByUserFullName(name);
