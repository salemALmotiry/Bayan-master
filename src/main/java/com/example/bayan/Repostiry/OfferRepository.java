...
public interface OfferRepository extends JpaRepository<Offer, Integer> {
 ...
 @Query("SELECT o FROM Offer o WHERE o.broker.id = :brokerId AND o.offerStatus NOT IN ('Canceled', 'Pending', 'Rejected') AND o.post IS NOT NULL")
 List<Offer> findActivePostOffersByBroker(@Param("brokerId") Integer brokerId);

 @Query("SELECT o FROM Offer o WHERE o.broker.id = :brokerId AND o.offerStatus NOT IN ('Canceled', 'Pending', 'Rejected') AND o.subscriptionPost IS NOT NULL")
 List<Offer> findActiveSubscriptionOffersByBroker(@Param("brokerId") Integer brokerId);



 List<Offer> findAllByBroker(CustomsBroker broker);
