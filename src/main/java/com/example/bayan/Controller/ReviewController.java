...
public class ReviewController {
    ...
    public ResponseEntity<?> brokerRateCustomer(@AuthenticationPrincipal MyUser broker, @PathVariable Integer orderId, @RequestBody @Valid ReviewCustomerDTO reviewCustomerDTO) {
    ...
    public ResponseEntity<?> customerRateBroker(@AuthenticationPrincipal MyUser customer, @PathVariable Integer orderId, @RequestBody @Valid ReviewBrokerDTO reviewBrokerDTO) {
    ...
    public ResponseEntity<?> updateBrokerReview(@AuthenticationPrincipal MyUser broker, @PathVariable Integer reviewId, @RequestBody @Valid ReviewCustomerDTO reviewCustomerDTO) {
    ...
    public ResponseEntity<?> updateCustomerReview(@AuthenticationPrincipal MyUser customer, @PathVariable Integer reviewId, @RequestBody @Valid ReviewBrokerDTO reviewBrokerDTO) {
