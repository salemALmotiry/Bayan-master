...
//____________________________________________-
    ...
    public ResponseEntity<?> getAllPostsByCategory(@PathVariable String category) {
        List<PostDTO> posts = postService.getAllPostsByCategory(category);
    ...
    public ResponseEntity<?> getAllPostsByCountryOfOrigin(@PathVariable String countryOfOrigin) {
        List<PostDTO> posts = postService.getAllPostsByCountryOfOrigin(countryOfOrigin);
        return ResponseEntity.ok(posts);
    }
    ...
    public ResponseEntity<?> getAllPostsByShipmentType(@PathVariable String shipmentType) {
        List<PostDTO> posts = postService.getAllPostsByShipmentType(shipmentType);
        return ResponseEntity.ok(posts);
    }
    ...
    public ResponseEntity<?> getAllPostsByCategoryAndCountryOfOrigin(@PathVariable String category, @PathVariable String countryOfOrigin) {
        List<PostDTO> posts = postService.getAllPostsByCategoryAndCountryOfOrigin(category, countryOfOrigin);
        return ResponseEntity.ok(posts);
    }
    ...
    public ResponseEntity<?> getAllPostsByCategoryAndShipmentType(@PathVariable String category, @PathVariable String shipmentType) {
        List<PostDTO> posts = postService.getAllPostsByCategoryAndShipmentType(category, shipmentType);
        return ResponseEntity.ok(posts);
    }
    ...
    public ResponseEntity<?> getAllPostsByCategoryAndShipmentTypeAndCountryOfOrigin(@PathVariable String category, @PathVariable String shipmentType, @PathVariable String countryOfOrigin) {
        List<PostDTO> posts = postService.getAllPostsByCategoryShipmentTypeAndCountry(category, shipmentType, countryOfOrigin);
        return ResponseEntity.ok(posts);
    }
    ...
    @GetMapping("/get-posts-by-border-name/{borderName}")
    public ResponseEntity<?> getAllPostByBorderName(@PathVariable String borderName) {
        List<Post> posts = postService.getAllPostByBorderName(borderName);
        return ResponseEntity.ok(posts);
    }
