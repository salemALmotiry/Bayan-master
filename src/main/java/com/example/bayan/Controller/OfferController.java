...
public class OfferController {
    ...
    // myOffersAsBroker
    @GetMapping("/my-offer-as-broker")
    public ResponseEntity<?> myOffersAsBroker(@AuthenticationPrincipal MyUser broker){
        return ResponseEntity.status(200).body(offerService.myOffersAsBroker(broker.getId()));
    }
