...
public class AuthController {
    ...
    @GetMapping("/custom-brokers/waiting-for-acceptance")
    public ResponseEntity<List<CustomBrokerForAdminDTO>> getBrokersWaitingForAcceptance(@AuthenticationPrincipal MyUser admin) {
        List<CustomBrokerForAdminDTO> brokers = authService.getBrokersWaitingForAcceptance(admin.getId());
        return ResponseEntity.status(200).body(brokers);
    }
